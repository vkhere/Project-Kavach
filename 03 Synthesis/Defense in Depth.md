...
- **Finding Citation**: 
  - [F-04 (Weak Auth / No Lockout)](../webapp/findings/F-04-auth-weakness/finding.md)
  - [Workstream A Attack 4 (Credential Abuse)](../network/report.md#2-evidence-mapping-mitre-attack)
...
- **Finding Citation**:
  - [F-01 (SQL Injection)](../webapp/findings/F-01-sqli/finding.md)
  - [F-02 (Stored XSS)](../webapp/findings/F-02-xss-stored/finding.md)
  - [Workstream A Attack 1 (C2 Beaconing)](../network/report.md#2-evidence-mapping-mitre-attack)
- **Implementation Effort**: **Medium (M)**
...
- **Finding Citation**:
  - [Workstream A Attack 3 (Lateral Movement via SMB/svcctl)](../network/report.md#2-evidence-mapping-mitre-attack)
  - [Workstream A Attack 5 (LDAP Discovery)](../network/report.md#2-evidence-mapping-mitre-attack)
...
- **Finding Citation**:
  - [F-01 (SQL Injection)](../webapp/findings/F-01-sqli/finding.md)
  - [F-02 (Stored XSS)](../webapp/findings/F-02-xss-stored/finding.md)
  - [F-03 (IDOR)](../webapp/findings/F-03-idor/finding.md)
...
- **Finding Citation**:
  - [F-01 (SQL Injection data dump)](../webapp/findings/F-01-sqli/finding.md)
  - [F-03 (IDOR address harvesting)](../webapp/findings/F-03-idor/finding.md)
- **Implementation Effort**: **Large (L)**
...
- **Finding Citation**:
  - [Workstream A Attack 1 (No-SNI Beaconing)](../network/report.md#2-evidence-mapping-mitre-attack)
  - [F-04 (Auditing Brute Force)](../webapp/findings/F-04-auth-weakness/finding.md)
- **Implementation Effort**: **Medium (M)**
...
- **Finding Citation**:
  - [Workstream A Attack 3 (Lateral spread to DC completed in 24 seconds)](../network/report.md#3-architecture-proposal-before-vs-proposed)
- **Implementation Effort**: **Small (S)**
